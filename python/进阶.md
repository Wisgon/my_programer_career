...
19. 将py脚本编译成so动态库：
    ...
    /home/xxx/anaconda3/envs/env_name/include/python3.7m/是python运行环境所在目录，这样，就在当前文件夹下生成了xxx.so了，可以像普通py文件一样导入函数等；<br><br>

20. 三个文件 a.py，b.py，c.py：
    a.py:
